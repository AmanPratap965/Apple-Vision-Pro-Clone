...
///calling loco function containing library for locomotive scroll
loco();
...
// document.querySelector("#page>video").addEventListener("timeupdate", function() {
//   const videoProgress = (this.currentTime / this.duration) * 100;
